      ...
      >
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">{t('about.version')}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">v0.83</p>
            </div>
          </div>
          ...
          <div className="pt-2">
            ...
            <div className="flex gap-2">
              {/* Discord */}
              <a
                href="https://discord.com/invite/w2S5jYfthj"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 p-3 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-lg transition-colors"
              >
              ...
              {/* GitHub */}
              <a
                href="https://github.com/aim840912/ChronoStorySearch"
                target="_blank"
                rel="noopener noreferrer"
