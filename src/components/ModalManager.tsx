...
interface ModalManagerProps {
  ...
  isSlotMachineModalOpen: boolean
  ...
  closeSlotMachineModal: () => void
  goBack: () => void

  // Modal 開啟函數
  openGachaModal: (machineId?: number) => void
  openSlotMachineModal: () => void
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[296px] sm:bottom-[384px] left-4 sm:left-6 z-40 p-3 sm:p-4 bg-pink-500 hover:bg-pink-600 dark:bg-pink-600 dark:hover:bg-pink-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 group"
        aria-label="拉霸機"
      >
        <div className="flex items-center gap-2">
          <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 10h2M18 14h2"/>
          </svg>
          <span className="text-sm font-medium hidden group-hover:inline-block">拉霸機</span>
        </div>
      </button>
