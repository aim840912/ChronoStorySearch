...
export function AdvancedFilterPanel({
  ...
  return (
    <div className="max-w-7xl mx-auto mb-4">
      ...
      <button
        onClick={onToggle}
        className="flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 bg-indigo-500 hover:bg-indigo-600 text-white shadow-md hover:shadow-lg"
      >
        <svg
