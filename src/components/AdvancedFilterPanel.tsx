          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1">
                <label htmlFor="level-min" className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                  {t('filter.levelRange.min')}
                </label>
                <input
                  id="level-min"
                  type="number"
              ...
              <div className="flex-1">
                <label htmlFor="level-max" className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                  {t('filter.levelRange.max')}
                </label>
                <input
                  id="level-max"
                  type="number"
